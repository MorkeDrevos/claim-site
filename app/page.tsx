...
<SoftCard className="relative overflow-hidden">
  {/* BACKGROUND: green CLAIM hero */}
  <div className="pointer-events-none absolute inset-0 -z-10">
    <Image
      src="/img/claim-hero-green.png"
      alt="$CLAIM hero"
      fill
      priority
  ...
  {/* FOREGROUND: existing hero layout */}
  <div className="relative flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
    ...
    <div className="flex-1 space-y-6">
      ...
      >
                ...
                >
                  ...
                  >
                    <p className="text-[14px] text-slate-200 leading-relaxed">
                      ...
                      among all wallets that lock in during the window. USD value
                      shown reflects an{' '}
                      <span className="text-emerald-300 font-medium">
                        approximate market conversion
                      </span>
        ...
        <div className="mt-6 space-y-0 text-[11.5px] text-slate-400/80 leading-relaxed">
          <p>
            • <span className="text-emerald-300/70 font-medium">Show up</span>{' '}
          ...
          <p>
            • Eligibility: hold 1,000,000 $CLAIM at the{' '}
            <span className="text-emerald-300/70 font-medium">snapshot</span> —
    ...
    <div className="w-full max-w-xs mt-[18px]">
      <SoftCard className="relative space-y-4 py-7 min-h-[340px]">
        {/* …all your Mission Control content exactly as you have it now… */}
        {/* (You can keep the block you already pasted for Mission Control here) */}
      </SoftCard>
    </div>
  </div>
</SoftCard>
