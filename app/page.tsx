...
const missionRows: MissionRow[] = [
  ...
  const snapshotDateLabel =
    snapshotTakenAt && !Number.isNaN(new Date(snapshotTakenAt).getTime())
      ? new Date(snapshotTakenAt).toLocaleString()
      : 'Not yet announced';
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 pb-14 pt-10 sm:px-6">
                ...
                <div className="flex items-start justify-between gap-6">
                  ...
                  <div className="flex flex-col items-end gap-1 text-right">
                    ...
                    <p className="text-[13px] font-medium text-emerald-300">
                      ≈ {rewardAmountText}
                      <span className="ml-1 text-[12px] text-emerald-400">
                        $CLAIM
                      </span>
                    </p>
                  </div>
        ...
        {/* Round progress, cards, tabs, snapshot info, etc… */}
        {/* (Use your existing blocks for these; they were structurally fine.) */}
