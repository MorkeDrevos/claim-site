...
export default function ClaimPoolPage() {
  ...
  const [preFlash, setPreFlash] = useState(false); // NEW
  ...
  /* ── Pre-flash 3s before stage change ── */
  ...
  useEffect(() => {
    if (!preFlash) return;
    const id = setTimeout(() => setPreFlash(false), 3000);
        ...
        <SoftCard>
          <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex-1 space-y-6">
              ...
              <div
                className={[
                  'mt-3 rounded-3xl border bg-gradient-to-b from-emerald-500/8 via-slate-950/80 to-slate-950/90 p-4 shadow-[0_24px_80px_rgba(16,185,129,0.45)]',
                  preFlash
